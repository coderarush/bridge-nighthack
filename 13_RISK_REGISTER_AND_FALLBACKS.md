...
| --- | --- | --- | --- | --- |
| Public deployment regresses after verification | The preserved flow was verified on `3407bf9`; application release `d67ce94` is live at the canonical product URL | Public health, protected-route, or room checks fail | Roll back to the verified `3407bf9` deployment and use the completed evidence chain | "The latest deployment regressed; this is the verified deployment and run." |
