...
- [x] Application release `d67ce94` is pushed, and the canonical deployment serves that application tree.
...
- [x] The final release received health, room, authorization, and desktop/mobile visual regression checks without resetting the preserved run.
...
- [x] `d67ce94` is recorded as the application boundary, and disclosure statistics/commit lists match that exact tag-to-application diff.
...
- [x] The current release passed its stated non-mutating regression and onboarding checks.
